========================================================================
    KONSOLENANWENDUNG: Peer2PeerTest-Projektübersicht
========================================================================

Diese Peer2PeerTest-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre Peer2PeerTest-Anwendung besteht.


Peer2PeerTest.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Peer2PeerTest.pch und eine 
