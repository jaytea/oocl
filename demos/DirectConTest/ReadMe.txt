========================================================================
    KONSOLENANWENDUNG: DirectConTest-Projektübersicht
========================================================================

Diese DirectConTest-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre DirectConTest-Anwendung besteht.


DirectConTest.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "DirectConTest.pch und eine 
